...
from qualibrate_app.api.routes.utils.slice import get_page_slice
...
class BranchLocalStorage(BranchBase):
    ...
    def _get_latest_snapshots_ids(
        ...
        ids = find_n_latest_nodes_ids_new(
            storage_location,
    ...
    def get_latest_snapshots(
        ...
        total = len(
            get_storage_by_project(self._settings.project, storage_location)
        )
