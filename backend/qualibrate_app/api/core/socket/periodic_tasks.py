...
ExcArgNoReturnAsyncFuncT: TypeAlias = Callable[
    [Exception], Coroutine[Any, Any, None]
]
NoArgsNoReturnAnyFuncT: TypeAlias = (
    NoArgsNoReturnFuncT | NoArgsNoReturnAsyncFuncT
)
ExcArgNoReturnAnyFuncT: TypeAlias = (
    ExcArgNoReturnFuncT | ExcArgNoReturnAsyncFuncT
)
