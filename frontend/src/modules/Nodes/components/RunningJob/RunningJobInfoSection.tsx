        ...
        <div className={styles.runInfoColumn}>
          ...
          {runningNodeInfo?.timestampOfRun && (
            <div className={styles.runInfoRow}>
              ...
              <div className={styles.jobInfoValue} data-testid="run-info-value-timestamp">
                {runningNodeInfo?.timestampOfRun}
              </div>
            </div>
          )}
          {runningNodeInfo?.runDuration && (
            <div className={styles.runInfoRow}>
              ...
              <div className={styles.jobInfoValue} data-testid="run-info-value-duration">
                {runningNodeInfo?.runDuration}&nbsp;s
              </div>
            </div>
          )}
        </div>
        <div className={styles.runInfoColumn}>
          {runningNodeInfo?.status && (
            <div className={styles.runInfoRow}>
              ...
              <div className={styles.jobInfoValue} data-testid="run-info-value-status">
                {runningNodeInfo?.status}
              </div>
            </div>
          )}
          {runningNodeInfo?.idx && (
            <div className={styles.runInfoRow}>
              ...
              <div className={styles.jobInfoValue} data-testid="run-info-value-idx">
                {runningNodeInfo?.idx}
              </div>
            </div>
          )}
